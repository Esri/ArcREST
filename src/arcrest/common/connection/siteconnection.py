...
class SiteConnection(object):
    ...
    #----------------------------------------------------------------------
    #----------------------------------------------------------------------
    def get(self, url, param_dict=None,
        ...
        if param_dict is None:
            if "params" in kwargs:
                param_dict = kwargs['params']
            elif "param_dict" in kwargs:
                param_dict = kwargs['param_dict']
            elif "postdata" in kwargs:
                param_dict = kwargs['postdata']
            else:
                param_dict = {}
        if try_json:
            param_dict['f'] = 'json'
